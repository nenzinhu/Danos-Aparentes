...
- diagrama-lateral-do-veculo-carro.png — 60KB, The image shows a dark blue cartoon car with a highlighted red front door against a light background.
- favicon.png — 3KB, A truck icon is displayed against a dark blue background.
- guias-de-vistoria-e-laudo.png — 57KB, A stylized blue car with an orange door is centered on a light, grid-patterned background.
- logo-b5d5d7ba.svg — 3KB, This icon features a blue stylized car silhouette with a magnifying glass overlaid on the front, all outlined in a dark blue.
- og-image.jpg — 41KB, A dark-background image showing a blue car-shield icon next to a stylized car with a red-highlighted front door.
- svgs/svg-4f444583.svg — This is a black, right-pointing arrow icon on a white background.
- svgs/svg-63d8eddd.svg — This is a black-and-white icon featuring a telephone handset inside a speech bubble.
- svgs/svg-7fd72790.svg — svg 7fd72790
- svgs/svg-a1da4190.svg — This is a simple, white line-art illustration of a car with dark blue outlines, wheels, and a roof rack.
- svgs/svg-eead9f32.svg — This is a simple, black, right-pointing arrow icon.
