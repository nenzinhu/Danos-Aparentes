# Danos Aparentes — Vistoria Digital de Avarias Veiculares
...
| `extracted/tokens.json` | Design tokens: 20 colors, 5 fonts, 20 headings, 6 CTAs |
...
- **Colors**: #141413 (surface-dark), #E5E7EB (bg-light), #E8E6DC (bg-light), #B0AEA5 (neutral), #FAF9F5 (bg-light), #44433F (neutral), #1E293B (accent), #020617 (bg-dark), #9E4428 (accent), #000000 (bg-dark)
- **Fonts**: Outfit (100-900 variable), Saira Condensed (500,600,700), IBM Plex Mono (400,500,600), __nextjs-Geist (400-600 variable), __nextjs-Geist Mono (400-600 variable)
