...
const WHATSAPP_MESSAGE =
  'Olá! Gostaria de saber mais sobre a Plataforma de Inteligência Histórica Veicular do Danos Aparentes para oficina.'
...
export function OficinasHeroCtas() {
  return (
    <div className="flex flex-wrap gap-4 justify-center mt-7">
      <LandingCtaLink id="oficinas-hero-cta" eventSource="oficinas" className={buttonVariants({ variant: 'primary', size: 'md' })}>
        {B2B_TRIAL_CTA}
      </LandingCtaLink>
...
export function OficinasFinalCta() {
  return (
    <div className="max-w-md mx-auto mt-16 text-center glass-card p-8">
      <h2 className="text-lg font-bold mb-1.5">Pronto para o histórico de evidência da sua oficina?</h2>
      <p className="text-sm text-[var(--text-muted)] mb-5">
        Teste 7 dias grátis no app — ou fale no WhatsApp se preferir.
      </p>
      <div className="flex flex-col gap-3">
        <LandingCtaLink
          id="oficinas-final-cta"
          eventSource="oficinas"
