...
import { trackCtaClick, trackSignupStart } from '@/src/lib/analytics/events'
...
export default function LocadorasTrialForm() {
  ...
  function onSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    trackLead()
    trackCtaClick({ source: 'locadoras', cta_id: 'locadoras-trial-form', destination: '/app?mode=signup' })
    trackSignupStart({ source: 'locadoras_trial_form' })
