    ...
    <>
      <div className="flex flex-col gap-2">
        {damages.map(d => {
          ...
          const evidenceBadge = d.evidenceStatus
            ? {
                ...evidenceStatusBadgeColors(d.evidenceStatus),
                label: formatEvidenceStatusLabel(d.evidenceStatus, {
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {evidenceBadge && (
                    <div className="mt-0.5">
                      <span
                        className="inline-block text-[0.62rem] font-bold px-1.5 py-0.5 rounded-md max-w-full truncate align-middle"
                        style={{ background: evidenceBadge.bg, color: evidenceBadge.fg }}
                      >
                        {evidenceBadge.label}
                      </span>
                    </div>
