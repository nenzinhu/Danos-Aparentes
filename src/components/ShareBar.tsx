...
// WhatsApp do contato: (48) 99183-8234 → formato internacional (Brasil +55)
const WHATSAPP_PHONE = '5548991838234'

function waContactLink(title: string) {
  const msg = encodeURIComponent(`Olá! Vi o artigo "${title}" no site da Danos Aparentes e queria saber mais sobre as vistorias.`)
  ...
  return (
    <div className="not-prose">
      ...
      <a
        ...
        className="mt-5 flex items-center justify-between gap-4 rounded-2xl border border-[var(--whatsapp-color)]/30 bg-[var(--whatsapp-color)]/10 px-5 py-4 transition-colors hover:bg-[var(--whatsapp-color)]/15 focus-visible:ring-2 ring-[var(--primary)] outline-none"
      >
        <div>
          <p className="text-sm font-bold text-[var(--text-main)]">Ficou com dúvidas sobre vistorias?</p>
          <p className="text-xs text-[var(--text-muted)] mt-0.5">Fale com a gente no WhatsApp · (48) 99183-8234</p>
        </div>
        <span className="inline-flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-extrabold text-white bg-[var(--whatsapp-color)] shrink-0">
