...
export default function AppTabBar({ activeTab, onTabChange, onNewInspection, onOpenSettings, onOpenTutorial, showTeamTab }: AppTabBarProps) {
  ...
  return (
    <div className="w-full min-w-0 flex justify-center mt-1 mb-1 px-2">
      <div
        ref={containerRef}
        className="theme-tabs bg-[var(--card-bg-solid)] border border-[var(--card-border)] rounded-xl p-1 flex items-center gap-0.5 justify-start lg:justify-center shadow-sm backdrop-blur-md w-full lg:w-auto max-w-full overflow-x-auto no-scrollbar lg:overflow-visible lg:flex-wrap"
      >
