...
// bundle inicial autenticado encurta o JS da aba padrão ("inspect").
...
/**
 * Shell autenticado de /app (inspect + overlays + paywall).
 * Carregado via next/dynamic a partir da page para que visitantes sem sessão
 * vejam o Login sem baixar InspectTab / veículos / sync.
 */
