...
export default function VanLateralRight({ damages, selectedPartId, onPartClick, onPartHover }: VehicleProps) {
  ...
  return (
    <svg viewBox="0 0 520 220" width="100%">
      ...
      {/* Teto alto */}
      <path {...partProps('van-lr-roof')} data-name="Teto da Van"
      ...
      <path {...partProps('van-lr-fender-rear')} data-name="Para-lama Traseiro"
      ...
      <path {...partProps('van-lr-fender-front')} data-name="Para-lama Dianteiro"
      ...
      {/* Soleira */}
      <path {...partProps('van-lr-sill')} data-name="Soleira da Van"
        d="M160,158 L360,158 L360,166 L160,166 Z" fill="#1e293b" stroke="#1e293b" strokeWidth="0.6" />

      {/* arco traseiro dianteiro (moldura preta) */}
      ...
      <circle {...partProps('van-rr-wheel-front')} data-name="Roda Dianteira Direita" cx="400" cy="158" r="32" />
