...
export default function CarLateralLeft({
  ...
  return (
    <svg viewBox="0 0 520 220" width="100%">
      {/* Sombra de contato no chão — mais suave e realista */}
      <ellipse cx="260" cy="190" rx="232" ry="13" fill="#000" opacity="0.28" filter="url(#shadow-filter)" />
      <ellipse cx="260" cy="192" rx="150" ry="6" fill="#000" opacity="0.30" filter="url(#shadow-filter)" />
      {/* Arcos de roda (caixa de roda) */}
      <path d="M75,160 A45,45 0 0,1 165,160 Z" fill="#0b1220" />
      <path d="M355,160 A45,45 0 0,1 445,160 Z" fill="#0b1220" />
      {!hideWheels && (
        <>
      ...
      <path d="M240,40 C290,30 350,30 385,38" stroke="#bae6fd" strokeWidth="1.5" opacity="0.5" fill="none" pointerEvents="none" />
      {/* Para-lama dianteiro */}
      ...
      {/* Vinco de porta (realismo) */}
      <path d="M275,84 L275,158" stroke="#04263b" strokeWidth="1.5" opacity="0.6" fill="none" pointerEvents="none" />
      <path d="M168,84 C170,120 170,140 166,156" stroke="#bae6fd" strokeWidth="1" opacity="0.35" fill="none" pointerEvents="none" />
      {/* Maçanetas */}
      <rect x="262" y="104" width="14" height="4" rx="2" fill="#04263b" opacity="0.8" pointerEvents="none" />
      <rect x="372" y="104" width="14" height="4" rx="2" fill="#04263b" opacity="0.8" pointerEvents="none" />
      {/* Para-lama traseiro */}
      ...
      {/* Reflexo de cintura (linha branca suave) */}
      <path d="M50,96 C100,92 180,95 240,95 C300,95 380,92 460,98" stroke="rgba(255,255,255,0.22)" strokeWidth="1.5" fill="none" pointerEvents="none" />
      {/* Linha de solo (sombra + luz) */}
      <path d="M170,148 L360,148" stroke="rgba(0,0,0,0.30)" strokeWidth="2" fill="none" pointerEvents="none" />
      <path d="M170,149 L360,149" stroke="rgba(255,255,255,0.12)" strokeWidth="1" fill="none" pointerEvents="none" />
      ...
      <path d="M32,118 C33,114 36,110 42,108 C39,118 35,123 32,118 Z" fill="#fef08a" opacity="0.85" pointerEvents="none" />
