...
export default function Car2dLateralRight({ damages, selectedPartId, onPartClick, onPartHover }: VehicleProps) {
  ...
  return (
    <svg viewBox="0 0 520 220" width="100%">
      ...
      <path d="M445,160 A45,45 0 0,0 355,160 Z" fill="#0f172a" />
      <path d="M165,160 A45,45 0 0,0 75,160 Z" fill="#0f172a" />
      ...
      <circle {...partProps('car2d-lr-wheel-front')} data-name="Roda Dianteira Direita" cx="400" cy="160" r="38" />
      <g pointerEvents="none">
      ...
      <circle {...partProps('car2d-lr-wheel-rear')} data-name="Roda Traseira Direita" cx="120" cy="160" r="38" />
      <path {...partProps('car2d-lr-glass-front')} data-name="Vidro Dianteiro Direito" d="M330,80 L272,42 L202,42 L202,80 Z" fill="url(#metal-glass)" opacity="0.85" stroke="#0f172a" strokeWidth="1" />
      <path {...partProps('car2d-lr-glass-rear')} data-name="Vidro Traseiro Direito" d="M198,42 L142,42 L102,80 L198,80 Z" fill="url(#metal-glass)" opacity="0.85" stroke="#0f172a" strokeWidth="1" />
      ...
      <path {...partProps('car2d-lr-roof')} data-name="Teto" d="M290,42 L132,42 C125,42 120,40 125,33 C140,24 170,22 240,22 C275,23 300,33 290,42 Z" fill="url(#metal-car-blue)" stroke="#1e293b" strokeWidth="1.5" />
      <path {...partProps('car2d-lr-door')} data-name="Porta Direita" d="M360,80 L220,80 L220,160 L360,160 C360,160 358,145 368,150 C365,135 360,122 360,80 Z" fill="url(#metal-car-blue)" stroke="#1e293b" strokeWidth="1" />
      <path {...partProps('car2d-lr-fender-rear')} data-name="Para-lama Traseiro Direito" d="M220,80 L140,80 C110,80 75,82 42,92 C28,105 32,125 38,132 C40,138 42,150 50,160 L78,160 C78,135 90,118 120,118 C150,118 162,135 162,160 L220,160 Z" fill="url(#metal-car-blue)" stroke="#1e293b" strokeWidth="1" />
      <path {...partProps('car2d-lr-fender-front')} data-name="Para-lama Dianteiro Direito" d="M488,118 C490,105 480,88 442,80 C410,78 385,80 360,80 C360,122 365,135 368,150 C375,125 390,118 400,118 C420,118 430,128 435,150 L488,150 C490,138 489,125 488,118 Z" fill="url(#metal-car-blue)" stroke="#1e293b" strokeWidth="1" />
      <path {...partProps('car2d-lr-sill')} data-name="Soleira Direita" d="M368,160 L150,160 L150,168 L368,168 Z" fill="#0f172a" stroke="#1e293b" strokeWidth="1" />
      <g {...partProps('car2d-lr-mirror')} data-name="Retrovisor Direito">
      ...
      <g pointerEvents="none">
        <rect x="225" y="88" width="16" height="4" rx="2" fill="#cbd5e1" stroke="#475569" strokeWidth="0.5" />
        <line x1="225" y1="90" x2="241" y2="90" stroke="#000" strokeWidth="1" />
      </g>
