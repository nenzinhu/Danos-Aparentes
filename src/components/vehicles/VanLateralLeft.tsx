    ...
    <svg viewBox="0 0 520 220" width="100%">
      ...
      <g transform="matrix(-1 0 0 1 520 0)">
        ...
        <g data-name="Painel Lateral de Carga">
          <path {...partProps('van-ll-panel-side')} data-name="Painel Lateral de Carga"
        ...
        {/* Porta da cabine */}
        <g data-name="Porta Dianteira Esquerda">
          <path {...partProps('van-ll-door-front')} data-name="Porta Dianteira Esquerda"
        ...
        <g data-name="Vidro da Porta">
          <path {...partProps('van-ll-glass-side')} data-name="Vidro da Porta"
        ...
        <g data-name="Vidro Dianteiro">
          <path {...partProps('van-ll-glass-front')} data-name="Vidro Dianteiro"
        ...
        {/* Retrovisor */}
        <g data-name="Retrovisor Esquerdo">
          <path {...partProps('van-ll-mirror')} data-name="Retrovisor Esquerdo" d="M400,86 L412,88 L412,82 Z" fill="#0f172a" />
