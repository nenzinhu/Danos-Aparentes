...
export default function MicroBusLateralRight({ damages, selectedPartId, onPartClick, onPartHover }: VehicleProps) {
  ...
  return (
    <svg viewBox="0 0 560 220" width="100%">
      ...
      <circle {...partProps('microbus-r-wheel-rear')} data-name="Roda Traseira Direita" cx="120" cy="168" r="30" />
      ...
      <circle {...partProps('microbus-r-wheel-front')} data-name="Roda Dianteira Direita" cx="470" cy="168" r="30" />

      {/* Carroceria / Lateral */}
      <path {...partProps('microbus-r-body')} data-name="Carroceria / Lateral"
      ...
      <g {...partProps('microbus-r-windows')} data-name="Janelas dos Passageiros">
      ...
      <g {...partProps('microbus-r-windshield')} data-name="Parabrisa Dianteiro (Lateral)">
      ...
      <g {...partProps('microbus-r-door')} data-name="Porta de Passageiros">
