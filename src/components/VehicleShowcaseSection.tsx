...
const vehicleOptions: VehicleOption[] = [
  ...
  },
  {
    type: 'car2d',
    name: 'Carro 2 Portas',
    IconComponent: IconVehicleCar2d,
    mockDamages: [
      {
  ...
  },
  {
    type: 'truck',
    name: 'Caminhão',
    IconComponent: IconVehicleTruck,
    mockDamages: [
      {
        id: 'mock-3' as any,
        vehicle: 'truck',
  ...
  },
  {
    type: 'microbus',
    name: 'Micro-ônibus',
    IconComponent: IconVehicleMicrobus,
    mockDamages: [
      {
...
function VehicleOptionButton({
  ...
  const IconComp = opt.IconComponent;
    ...
    >
      <div className="flex items-center gap-3">
        <span className="p-2 rounded-lg bg-white/10 flex items-center justify-center shrink-0">
          <IconComp size={22} className={isActive ? 'text-white' : 'text-[var(--text-main)]'} />
        </span>
        <span>{opt.name}</span>
      </div>
      {isActive && (
