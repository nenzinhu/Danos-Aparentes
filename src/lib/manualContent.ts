...
export const MANUAL_STEPS: ManualStep[] = [
  {
    ...
    highlights: [
      ...
      { icon: 'list', label: 'Lista de danos', text: 'Tudo que você marcou, com botões para assinar e gerar o laudo em PDF.' },
    ],
  },
  {
    num: 2,
    ...
    highlights: [
      ...
      { icon: 'zap', label: 'Preenche na hora', text: 'Marca, modelo, ano, cor, cidade e estado aparecem automaticamente.' },
      { icon: 'pencil', label: 'Pode corrigir', text: 'Se faltar algo ou estiver errado, você edita qualquer campo na mão, quando quiser.' },
    ],
  },
  {
    num: 3,
    ...
    image: '/vehicles-img/car.webp',
    imageAlt: 'Desenho do veículo com peça danificada em destaque',
    highlights: [
      { icon: 'van', label: 'Vários veículos', text: 'Escolha carro, moto, caminhão, van, ônibus ou micro-ônibus — o desenho muda para cada um.' },
      { icon: 'rotate', label: 'Os 4 lados', text: 'Veja o veículo pela lateral esquerda, lateral direita, frente e traseira.' },
      { icon: 'tap', label: 'Toque na peça', text: 'Cada parte (para-choque, porta, retrovisor, vidro) é separada. Toque exatamente na peça danificada para registrar.' },
    ],
  },
  {
    num: 4,
    ...
    images: [
      { src: '/damage/porta-riscada.svg', alt: 'Porta de veículo com risco e abrasão na lataria' },
      { src: '/damage/porta-amassada.svg', alt: 'Porta de veículo amassada e deformada' },
      { src: '/damage/porta-trincada.svg', alt: 'Porta de veículo com painel quebrado e trincado' },
    ],
    highlights: [
  ...
  },
  {
    ...
    highlights: [
      ...
      { icon: 'news', label: 'Editorial', text: 'Visual mais elegante e espaçado, bom para carros importados ou de luxo.' },
  ...
  },
  {
    ...
    highlights: [
      { icon: 'signature', label: 'Assinatura na tela', text: 'Você e o cliente assinam com o dedo, direto na tela do celular.' },
