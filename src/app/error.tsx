  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center gap-4 bg-[var(--bg-main)] text-[var(--text-main)] px-6 text-center">
      ...
      <div className="flex gap-3">
        <button
          onClick={() => reset()}
          className="text-sm px-4 py-2 rounded-lg font-bold border border-[var(--primary)]/30 bg-[var(--primary)]/10 text-[var(--primary)] hover:bg-[var(--primary)]/20 transition-all"
        >
          Tentar novamente
        </button>
        <button
