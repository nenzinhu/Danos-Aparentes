...
const DESCRIPTION =
  'Conhecimento para quem transforma vistorias em evidências e histórico veicular confiável. Guias de laudo, avarias e comparação para locadoras, frotas e oficinas.'
...
export default function BlogIndexPage() {
  ...
  const blogJsonLd = {
    ...
    name: TITLE,
    description: DESCRIPTION,
    url: 'https://danosaparentes.com.br/blog',
    isPartOf: { '@type': 'WebSite', name: 'Danos Aparentes', url: 'https://danosaparentes.com.br' },
    mainEntity: {
      '@type': 'ItemList',
      itemListElement: BLOG_POSTS.slice(0, 20).map((post, i) => ({
        '@type': 'ListItem',
        position: i + 1,
        url: `https://danosaparentes.com.br/blog/${post.slug}`,
        name: post.title,
      })),
    },
  }
    ...
    <main className="min-h-screen w-full flex flex-col items-center px-4 py-12 font-outfit text-[var(--text-main)]">
      ...
      <div className="w-full max-w-4xl">
        ...
        {featured && (
          ...
          >
            <BlogCover cover={featured.cover} title={featured.title} className="h-44 sm:h-52">
