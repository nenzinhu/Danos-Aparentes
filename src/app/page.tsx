...
const FAQ_ITEMS = [
  { q: "Qual o valor da assinatura do aplicativo?", a: "Temos o plano Starter por R$ 29,90/mês (até 20 laudos em PDF por mês) e o plano Pro por R$ 49,90/mês (até 80 laudos em PDF por mês, com relatórios personalizados, consulta de placas e mais funcionalidades). Para frotas e empresas com múltiplos vistoriadores, temos o plano Corporativo com laudos ilimitados e preços sob medida – consulte-nos clicando em 'Consulte agora mesmo'." },
